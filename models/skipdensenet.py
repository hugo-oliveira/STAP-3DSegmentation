...
###########################################################################
# Code adapted from: https://github.com/black0017/MedicalZooPytorch #######
###########################################################################
...
class SkipDenseNet3D(nn.Module):
    ...
    def __init__(self, in_channels=2, num_classes=4, growth_rate=16, block_config=(4, 4, 4, 4), num_init_features=32, drop_rate=0.1, bn_size=4):
