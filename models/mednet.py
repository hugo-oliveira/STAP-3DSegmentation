...
and here: https://github.com/black0017/MedicalZooPytorch/blob/master/lib/medzoo/ResNet3DMedNet.py
...
class TranspConvNet(nn.Module):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.conv_final = conv1x1x1(conv_channels, num_classes, stride=1)
...
#                  block_inplanes=[16, 32, 64, 128],
        ...
        self.segm = TranspConvNet(in_channels=block_inplanes[3] * block.expansion, num_classes=num_classes)
#         self.segm = TranspConvNet(in_channels=512 * block.expansion, num_classes=num_classes)
